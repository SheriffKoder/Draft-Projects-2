...
const GsapScrollTrigger = () => {
  ...
  //give this ref to the div wrapping the boxes
  //to access them
  ...
  useGSAP(() => {
    ...
    boxes.forEach((box, index) => {
      gsap.to(box, {
        ...
        scrollTrigger: {
          trigger: box,
          start: "bottom bottom",  //animation start when reach the end of the element, if this is not present then on-view
          end: "top 20%", //when the box hits 20% of the viewport 1-100% duration will be longer->less on screen
    ...
    //know exactly when the animation has to happen
  }, {scope: scrollRef})
